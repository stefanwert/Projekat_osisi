...
public class DialogStudent extends JDialog {
 ...
 private static DialogStudent instance =null;
	...
	public DialogStudent(Frame parent, String title, boolean modal) {
		...
		lblIme.setFont(new Font("Ime:",Font.PLAIN,12));
		JLabel lblPrezime=new JLabel("Prezime:");
		lblPrezime.setFont(new Font("Prezime:",Font.PLAIN,12));
		JLabel lblDatumRodjenja=new JLabel("Datum rodjenja:");
		lblDatumRodjenja.setFont(new Font("Datum rodjenja:",Font.PLAIN,12));
		JLabel lblAdresaStanovanja=new JLabel("Adresa stanovanja:");
		lblAdresaStanovanja.setFont(new Font("Adresa stanovanja:",Font.PLAIN,12));
		JLabel lblBrojTelefona=new JLabel("Broj telefona:");
		lblBrojTelefona.setFont(new Font("Broj telefona:",Font.PLAIN,12));
		JLabel lblBrojIndeksa=new JLabel("Broj indeksa:");
		lblBrojIndeksa.setFont(new Font("Broj indeksa:",Font.PLAIN,12));
		JLabel lblTrenutnaGodinaStudija=new JLabel("Trenutna godina studija:");
		lblTrenutnaGodinaStudija.setFont(new Font("Trenutna godina studija:",Font.PLAIN,12));
		...
		txtPrezime.setPreferredSize(new Dimension(190,20));
		txtDatumRodjenja=new JTextField();
		txtDatumRodjenja.setPreferredSize(new Dimension(180,20));
		txtAdresaStanovanja=new JTextField();
		txtAdresaStanovanja.setPreferredSize(new Dimension(170,20));
		txtBrojTelefona=new JTextField();
		txtBrojTelefona.setPreferredSize(new Dimension(185,20));
		txtBrojIndeksa=new JTextField();
		txtBrojIndeksa.setPreferredSize(new Dimension(185,20));
		
		GridBagConstraints gblblIme=new GridBagConstraints();
		gblblIme.gridx=0;
		gblblIme.gridy=0;
		gblblIme.insets=new Insets(15, 0, 10, 0);
		gblblIme.anchor=GridBagConstraints.CENTER;
		panel.add(lblIme,gblblIme);
		GridBagConstraints gbtxtIme=new GridBagConstraints();
		gbtxtIme.gridx=1;
		gbtxtIme.gridy=0;
		gbtxtIme.insets=new Insets(15, 5, 10, 0);
		gbtxtIme.anchor=GridBagConstraints.CENTER;
		...
		gblblPrezime.insets=new Insets(15, 0, 10, 0);
		...
		gbtxtPrezime.insets=new Insets(15, 5, 10, 0);
		gbtxtPrezime.anchor=GridBagConstraints.CENTER;
		...
		gblblDatumRodjenja.insets=new Insets(15, 0, 10, 0);
		...
		gbtxtDatumRodjenja.insets=new Insets(15, 5, 10, 0);
		gbtxtDatumRodjenja.anchor=GridBagConstraints.CENTER;
		gbtxtIme.weightx=100;
		...
		gblblAdresaStanovanja.insets=new Insets(15, 0, 10, 0);
		...
		gbtxtAdresaStanovanja.insets=new Insets(15, 5, 10, 0);
		gbtxtAdresaStanovanja.anchor=GridBagConstraints.CENTER;
		gbtxtIme.weightx=100;
		...
		gblblBrojTelefona.insets=new Insets(15, 0, 10, 0);
		...
		gbtxtBrojTelefona.insets=new Insets(15, 5, 10, 0);
		gbtxtBrojTelefona.anchor=GridBagConstraints.CENTER;
		...
		gblblBrojIndeksa.insets=new Insets(15, 0, 10, 0);
		...
		gbtxtBrojIndeksa.insets=new Insets(15, 5, 10, 0);
		gbtxtBrojIndeksa.anchor=GridBagConstraints.CENTER;
		...
		gblblTrenutnaGodinaStudija.insets=new Insets(15, 0, 10, 0);
		...
		gbtxtcb.gridx=1;
		gbtxtcb.gridy=6;
		gbtxtcb.insets=new Insets(15, 5, 10, 0);
