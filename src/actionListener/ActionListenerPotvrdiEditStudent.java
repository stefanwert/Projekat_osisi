...
public class ActionListenerPotvrdiEditStudent implements ActionListener {
	@Override
	...
	try {
	   ...
	   StudentKontroler.getInstance().izmeniStudenta(ime, prezime, datumr, adresa, brojtel, null, index, null, godina, student.getStatus(), prosek, null, null);
	} catch (Exception e2) {
		e2.printStackTrace();
	}
